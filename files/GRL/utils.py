...
class function:
    ...
    def create_one_hot_converter(self, n_powerlines,n_substations,total_bus_actions):
        """
    ...
    def convert_one_hot_encoding_act_to_env_act(self, env_act_dict_list,one_hot_encoding_act,env):
        """
