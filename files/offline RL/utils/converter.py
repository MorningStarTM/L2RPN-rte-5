...
class Converter:
    ...
    def convert_env_act_to_one_hot_encoding_act(self, one_hot_encoding_act_conv,env_act):
        """
    ...
    def convert_one_hot_encoding_act_to_env_act(self, action_encoded, env_act_dict_list,one_hot_encoding_act):
        """
        Converts a one hot encoding action to a grid2op action
        """
        return self.env.action_space(env_act_dict_list[action_encoded.argmax().item()])
